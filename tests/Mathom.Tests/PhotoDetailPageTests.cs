...
[Collection("postgres")]
public class PhotoDetailPageTests
{
    private readonly PostgresFixture _fx;
    public PhotoDetailPageTests(PostgresFixture fx) => _fx = fx;
    ...
    public async Task NotePage_RendersPhotoImages()
    {
        ...
        await using (var db = _fx.NewDbContext()) { db.Items.Add(item); await db.SaveChangesAsync(); }
