...
namespace Mathom.Web.Data.Migrations
{
    ...
    [Migration("20260625084639_AddPhotoDisplayVariant")]
    partial class AddPhotoDisplayVariant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mathom.Web.Domain.GlossaryVariant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GlossaryTermId", "Text")
                        .IsUnique();

                    b.ToTable("GlossaryVariants");
                });
            ...
            modelBuilder.Entity("Mathom.Web.Domain.ItemPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Mathom.Web.Domain.GlossaryVariant", b =>
                {
                    b.HasOne("Mathom.Web.Domain.GlossaryTerm", null)
                        .WithMany("Variants")
